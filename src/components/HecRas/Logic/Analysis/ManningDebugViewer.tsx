          ...
          <div className='bg-white/5 rounded-lg p-4'>
            ...
            <div className='space-y-2 text-sm'>
              <div className='flex justify-between'>
                ...
                <span
                  className={manningData ? 'text-green-400' : 'text-red-400'}
                >
                  {manningData ? 'Yes' : 'No'}
                </span>
              </div>
              <div className='flex justify-between'>
                ...
                <span
                  className={
                    manningData?.success ? 'text-green-400' : 'text-red-400'
                  }
                >
              ...
              <div className='flex justify-between'>
                ...
                <span
                  className={
                    manningData?.manning_data?.success
                      ? 'text-green-400'
                      : 'text-red-400'
                  }
                >
        ...
        {manningData?.manning_data?.manning_zones && (
          <div className='bg-white/5 rounded-lg p-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2'>
              {Object.entries(manningData.manning_data.manning_zones)
                .slice(0, 6)
