...
export const HecRas: React.FC<HecRasProps> = ({
  ...
  // titlebar: 48px, license panel expandido: ~160px, menu: ~80px, footer: 60px
    ...
    <div className='w-full h-full relative bg-[#131414] flex flex-col'>
      ...
      <div
        ...
        style={{
          ...
          paddingBottom: `${footerHeight}px` // Espacio para el footer fijo
        }}
      >
      ...
      <footer className='fixed bottom-0 left-0 right-0 px-6 py-3 border-t border-white/5 bg-[#131414]/95 backdrop-blur-sm z-20'>
